<div class="title-holder"><h5 id="title">组织架构信息导入</h5></div>
	...
	<form id="emp-upload-form" class="form-horizontal required-validate" enctype="multipart/form-data" name="fileinfo">
		<div class="form-group">
			...
			<div class="col-md-10">
				...
				<input name="t"  value="02"  type="hidden" >
				<a id="upload-button" class="btn btn-default btn-transparent" ><span class="glyphicon glyphicon-open"></span> 选择组织文件</a>   
		...
		<div class="form-group">
			...
			<div class="col-lg-10">
				...
				<a class="cancels" href="#acheupload">取消</a>
			</div>
		</div>
		<div class="form-group">
			<div class="col-lg-2"></div>
