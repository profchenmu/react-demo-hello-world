...
], function(Marionette, Radio, checkDenyTemplate, bootstrapValidator) {
    'use strict';
    ...
    return Marionette.LayoutView.extend({
        ...
        _shownModal: function(){
            ...
            .on('success.form.bv', function(e){
                ...
                $.ajax({
                    url: window.getApi('/getService.do?serviceId=4000330000001042'),
                    type: 'POST',
                    data: {
                        id: self.id,
                        functionType: 2,
                    ...
                    success: function(res){
                        if(res.code === '00'){
                            Radio.channel('listChange5').trigger('reset');
