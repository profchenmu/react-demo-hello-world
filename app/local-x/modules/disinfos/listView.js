define([
...
], function(_, Marionette, App, Radio, listViewTpl, ItemView, UsersCollection, pagination) {
    'use strict';
    ...
    return Marionette.CompositeView.extend({
        ...
        initialize: function() {
            ...
            Radio.channel('listChange2').on('reset', function(e){
                self._renderPage(1);
            });
        },
